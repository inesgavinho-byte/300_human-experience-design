...
export function validateOutputs(
  ...
  schema?: OutputSchema | Record<string, any>
): ValidationResult {
  ...
  // Schema validation
  if (schema) {
    const schemaErrors = validateAgainstSchema(result.outputs, schema as OutputSchema, '');
...
function checkType(value: any, expectedType: string, path: string): string | null {
